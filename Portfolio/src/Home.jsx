...
function Home() {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? "bg-gray-900 text-white" : "bg-white text-gray-900"} flex flex-col items-center justify-center px-6 relative`}>
      ...
      <Link to="/profile">  
        <motion.button
          className="mt-8 px-6 py-3 bg-blue-500 rounded-lg text-lg font-semibold hover:bg-blue-600 transition"
          initial={{ scale: 0.9 }}
          animate={{ scale: 1 }}
